...
let failed = 0;
for (const suite of ['editor', 'features', 'fixes', 'hardening', 'multiinstance', 'tables', 'datatype', 'inspector', 'nesting', 'authoring', 'invariants', 'select', 'notion', 'typeahead', 'dragnest']) {
    console.log(`\n=== ${suite} ===`);
