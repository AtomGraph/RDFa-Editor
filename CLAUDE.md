...
- Playwright smoke scripts: `editor-smoke.mjs` (editor, 16 groups) and `round2-smoke.mjs` (undo/ToC/breadcrumb/lint/find, 10 groups) in the session scratchpad; serve the repo and run with `playwright-core` against Chromium.
